          ...
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-gradient-to-br from-[#1A3A5C] to-[#4A9B7E] rounded-xl flex items-center justify-center">
                ...
                <div>
                  ...
                  <a href="tel:+89380000599" className="text-[#4A9B7E] hover:text-[#1A3A5C] transition-colors font-medium">
                    +8 (938) 000-05-99
                  </a>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:kataloff.if@yandex.com" className="text-[#4A9B7E] hover:text-[#1A3A5C] transition-colors font-medium">
